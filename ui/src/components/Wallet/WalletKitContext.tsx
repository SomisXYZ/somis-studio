...
import { createWalletKitCore, WalletKitCore, WalletKitCoreOptions, WalletKitCoreState } from '@mysten/wallet-kit-core'
...
export function WalletKitProvider({
    ...
    return <WalletKitContext.Provider value={walletKitRef.current}>{children}</WalletKitContext.Provider>
}

type UseWalletKit = WalletKitCoreState &
    Pick<
        WalletKitCore,
        'connect' | 'disconnect' | 'signMessage' | 'signTransactionBlock' | 'signAndExecuteTransactionBlock'
    >
